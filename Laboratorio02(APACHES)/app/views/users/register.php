            ...
            <div class="col-md-6">
                <div class="card shadow-sm">
                    <div class="card-header bg-primary text-light">
                        <h4 class="card-title mb-0">Registro de nuevo usuario</h4>
                    </div>
                    <div class="card-body">
                        <form action="<?php echo urlRoot; ?>/users/register" method="post">
                            ...
                            <div class="mb-3">
                                <label for="txtContra2" class="form-label"><strong>Repita clave:</strong></label>
                                <input type="password" name="txtContra2" class="form-control <?php echo (!empty($data['passError2'])) ? 'is-invalid' : ''; ?>" maxlength="15" required>
                                <div class="invalid-feedback">
